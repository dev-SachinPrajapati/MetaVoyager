    ...
    <section className='sm:p-16 xs:p-8 px-6 py-12 relative z-10'>
      ...
      >
        ...
        >
          ...
          <div className='positon absolute top-[300px] left-[45%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5d6680]'>
            <img
              src='world-left.png'
              alt='World Left'
              className='w-full h-full'
          ...
          <div className='positon absolute top-[150px] left-[60%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5d6680]'>
            <img
              src='world-right.png'
              alt='World Right'
              className='w-full h-full'
